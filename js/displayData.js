        ...
        Object.keys(usersData).forEach(userId => {
          ...
          post.innerHTML = `
            <div class="post">
              ...
              <hr>
              <div>
                <button onclick="showMessageForm('${user.Numero}', '${user.Adresse}')"><i class="fab fa-whatsapp"></i> </button>
                <button onclick="showMessageForm('${user.Numero}', '${user.Adresse}')">Bip</button>
                <button onclick="showMessageForm('${user.Numero}', '${user.Adresse}')">Sms</button>
              </div>
            </div>
